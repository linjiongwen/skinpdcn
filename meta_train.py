...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', default='meta_Skinpbdcn', choices=['meta_Skinpbdcn', 'protonet'])
    ...
    parser.add_argument('--num_classes', default=2, type=int, help='total number of classes in pretrain')
