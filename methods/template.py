...
class BaselineTrain(nn.Module):
    def __init__(self, params, model_func, num_class):
        ...
        if params.method in ['stl_deepbdc', 'meta_Skinpbdcn', 'protonet', 'good_embed']:
    ...
    def feature_forward(self, x):
        ...
        if self.params.method in ['stl_deepbdc', 'meta_Skinpbdcn']:
            out = self.dcov(out)
    ...
    def forward_meta_val(self, x):
        ...
        if self.params.method in ['meta_Skinpbdcn']:
