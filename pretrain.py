...
def train(params, base_loader, val_loader, model, stop_epoch):
    ...
    if params.method in ['stl_deepbdc', 'meta_Skinpbdcn']:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=32, type=int, help='pre-training batch size')
    parser.add_argument('--lr', type=float, default=0.02, help='initial learning rate of the backbone')
    ...
    parser.add_argument('--gamma', type=float, default=0.2, help='learning rate decay factor')
    parser.add_argument('--milestones', nargs='+', type=int, default=[100, 150], help='milestones for MultiStepLR')
    parser.add_argument('--epoch', default=250, type=int, help='stopping epoch')
    ...
    parser.add_argument('--val_n_way', default=2, type=int, help='number of  classes to classify in meta validation')
    ...
    parser.add_argument('--num_classes', default=2, type=int, help='total number of classes in training')
